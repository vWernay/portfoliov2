...
export const careerProjects: { [key: string]: PersonalProject[] } = {
  Works: [
    {
      name: "ZentriX Shop",
      image: { url: "/images/zentrix_shop_preview.webp", alt: "ZentriX Shop Website" },
    ...
    },
    {
      ...
      image: { url: "/images/if_developments_preview.webp", alt: "IF Developments Page" },
  ...
  Freelance: [
    ...
    {
      name: "FuelTech NUI",
      image: { url: "/images/brp_fueltech.webp", alt: 'FuelTech In game (GTA 5)' },
      summary:
    ...
    {
      name: "WheelSpin NUI",
      image: { url: "/images/brp_wheelspin.webp", alt: 'WheelSpin In game (GTA 5)' },
      summary:
    ...
    {
      name: "Groupmanager",
      image: { url: "/images/groupmanager.webp", alt: 'Groupmanager In game (GTA 5)' },
  ...
  "Open Source": [
    ...
    },
    {
      ...
      image: { url: "/images/node-pg-csv.webp", alt: 'Illustration with PostgreSQL, Node.js and CSV icons.' },
    ...
    },
    {
      ...
      image: { url: "/images/time_capsule_preview.webp", alt: 'Time Capsule Previews' },
